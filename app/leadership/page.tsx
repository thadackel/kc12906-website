      ...
      <main className="mx-auto max-w-7xl px-6 py-16">
        ...
        <div className="mx-auto mt-12 grid max-w-5xl gap-6 md:grid-cols-2">
          <div className="rounded-2xl border p-8 shadow-sm">
            <p className="text-sm font-black uppercase tracking-[0.25em] text-yellow-600">Grand Knight</p>
          ...
          <div className="rounded-2xl border p-8 shadow-sm">
            ...
            <p className="mt-4 leading-7 text-slate-600">Add Deputy Grand Knight, Chancellor, Recorder, Treasurer, Advocate, Warden, Guards, Trustees, and program personnel here when confirmed.</p>
          </div>
        </div>
      </main>
      <Footer />
