      ...
      <main className="mx-auto max-w-6xl px-6 py-16">
        ...
        <section className="mt-8 overflow-hidden rounded-3xl border border-slate-200 bg-white shadow-lg">
          ...
          <div className="p-8 md:p-12">
            ...
            <div className="mt-6 space-y-5 text-lg leading-8 text-slate-700">
              <p>
                The Free Throw Contest gives young participants an opportunity
                to demonstrate their basketball skills in a welcoming community
                setting.
              </p>
              <p>
                Council members support the event by helping with registration,
                scoring, encouragement, and event coordination.
              </p>
              <p>
                Future contest dates, eligibility information, and registration
        ...
        <section className="mt-10">
          <h2 className="text-3xl font-black text-blue-950">
            Free Throw Contest Photo Gallery
          </h2>
