...
const gallery = [
  {
    ...
    alt: "Council 12906 Knights preparing barbecue",
  },
  {
        ...
        <section className="mt-8 overflow-hidden rounded-3xl border border-slate-200 bg-white shadow-lg">
          ...
          <div className="p-8 md:p-12">
            ...
            <div className="mt-6 space-y-5 text-lg leading-8 text-slate-700">
              <p>
                The Knights of Columbus Council 12906 proudly prepares and
                serves delicious BBQ plates for members of our parish and the
                surrounding community.
              </p>

              <p>
                Each event brings our brother Knights together in service,
                fellowship, and support of parish life. Every plate is prepared
                with care and a spirit of hospitality.
              </p>

              <p>
                Proceeds help support the charitable and service work of our
                council. Event dates, menus, pickup information, and pricing
        ...
        <section className="mt-10">
          ...
          <div className="mt-6 grid gap-6 md:grid-cols-2">
            {gallery.map((photo) => (
              <div
                key={photo.src}
                className="relative aspect-[4/3] overflow-hidden rounded-3xl border border-slate-200 bg-slate-100 shadow-md"
              >
                <Image
                  src={photo.src}
                  alt={photo.alt}
