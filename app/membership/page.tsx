  ...
  return (
    <>
      ...
      <main className="mx-auto max-w-7xl px-6 py-16">
        ...
        <section className="mt-14 rounded-2xl bg-blue-950 p-10 text-center text-white">
          ...
          <p className="mx-auto mt-4 max-w-2xl text-lg text-slate-100">
            Visit a meeting, speak with Grand Knight Gerald Nuss, or contact the
            council for more information about membership.
          </p>
          <Link
            href="/contact"
            className="mt-8 inline-block rounded-md bg-yellow-500 px-8 py-3 font-black text-blue-950 hover:bg-yellow-400"
          >
            Contact the Council
          </Link>
        </section>
